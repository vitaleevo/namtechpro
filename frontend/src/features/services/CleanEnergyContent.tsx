...
export const CleanEnergyContent = () => {
    ...
    return (
        <div className="pt-20 overflow-x-hidden">
            ...
            <section className="relative h-[80vh] flex items-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image
                        ...
                        src="/images/decorativas/oil-platform.jpg"
                    />
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-3xl text-white">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            <Link href="/catalogo" className="px-10 py-5 bg-slate-900/40 border border-white/20 text-white rounded-xl font-bold text-lg hover:bg-slate-900/60 transition-all text-center">
            ...
            <section className="relative z-20 -mt-12 max-w-5xl mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className="bg-slate-900 p-8 rounded-2xl shadow-xl border border-white/5 text-center">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col md:flex-row items-end justify-between mb-20 gap-8">
                        <div className="max-w-2xl">
                            <h2 className="text-4xl md:text-6xl font-display font-bold text-white mb-6">{t.cleanEnergyPage.innovationTitle} <span className="text-emerald-500">{t.cleanEnergyPage.innovationHighlight}</span></h2>
                        ...
                        {[
                            {
                                ...
                                icon: 'electric_bolt',
                                features: t.cleanEnergyPage.electricPropulsionFeatures
                            },
                            {
                                title: t.cleanEnergyPage.essContainers,
                                desc: t.cleanEnergyPage.essContainersDesc,
                                icon: 'battery_charging_full',
                                features: t.cleanEnergyPage.essContainersFeatures
                            },
                            {
                                title: t.cleanEnergyPage.marineSolar,
                                desc: t.cleanEnergyPage.marineSolarDesc,
                                icon: 'wb_sunny',
                                features: t.cleanEnergyPage.marineSolarFeatures
                            }
                        ].map((sol, i) => (
                            <div key={i} className="group relative p-10 rounded-[2.5rem] bg-slate-800/40 border border-white/5 hover:border-emerald-500/50 transition-all duration-500">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                        ...
                        <div className="relative">
                            <div className="aspect-square rounded-[4rem] overflow-hidden shadow-2xl border-8 border-white/5 relative">
                                <Image src="/images/decorativas/aquaculture-aerial.jpg" alt="Solar Panels Installation" fill className="object-cover" />
                            </div>
            ...
            <section className="py-24 bg-white border-b border-white/5">
                <div className="max-w-7xl mx-auto px-4 text-center">
                    ...
                    <div className="flex flex-wrap justify-center gap-12 md:gap-24 opacity-40 grayscale hover:grayscale-0 transition-all duration-700">
                        {['VICTRON ENERGY', 'SUNPOWER', 'TESLA ENERGY', 'SMA', 'FRONIUS'].map((p, i) => (
                            <span key={i} className="text-2xl md:text-3xl font-display font-black tracking-tighter text-white">{p}</span>
                        ))}
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 bg-slate-900">
                <div className="max-w-4xl mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl font-display font-bold text-white mb-4">{t.cleanEnergyPage.faqTitle}</h2>
                    ...
                    <div className="space-y-4">
                        {[
                            ...
                            <details key={i} className="group bg-slate-800/30 rounded-2xl border border-white/5 overflow-hidden">
