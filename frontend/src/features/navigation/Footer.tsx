            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
                    ...
                    <div>
                        ...
                        <p className="text-slate-400 text-sm mb-1">{t.footer.office}: +244 921 791 515</p>
                        <p className="text-slate-400 text-sm mb-2">{t.footer.shop}: +244 921 807 557</p>
                        ...
                        <div className="flex gap-4">
                            <a href="https://www.facebook.com/Namtechpro" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-black/40 flex items-center justify-center hover:bg-secondary hover:text-primary transition-all">
                                <span className="material-symbols-outlined text-sm">public</span>
                            </a>
                            <a href="https://www.instagram.com/namtechpro/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-black/40 flex items-center justify-center hover:bg-secondary hover:text-primary transition-all">
