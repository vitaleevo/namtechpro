    ...
    return (
        <main className="min-h-screen bg-white flex flex-col">
            ...
            <div className="flex-1 max-w-4xl mx-auto px-4 py-32">
                ...
                <div className="prose prose-slate bg-slate-50 p-12 rounded-3xl shadow-sm border border-slate-100">
                    <p className="mb-6 text-slate-500 font-medium">Última atualização: Janeiro 2025</p>
                    <h2 className="text-xl font-bold text-primary mb-4">1. Recolha de Dados</h2>
                    ...
                    <h2 className="text-xl font-bold text-primary mb-4">2. Uso de Informações</h2>
                    ...
                    <h2 className="text-xl font-bold text-primary mb-4">3. Retenção de Dados</h2>
